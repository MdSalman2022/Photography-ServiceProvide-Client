        ...
        <div className='w-full flex justify-center mx-auto my-20'>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-neutral text-white mx-5 lg:mx-auto">
                ...
                <div className="my-6 space-y-4">
                    ...
                    <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md hover:bg-primary  hover:text-neutral hover:transition-2s duration-300    focus:ring-violet-400">
